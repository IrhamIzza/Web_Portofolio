  ...
  const project = [
    {
      ...
      framework: ["React", "Tailwind CSS", "Shadcn ui", "Swiper"],
    },
    {
      src: project2,
      ...
      framework: ["React", "Tailwind CSS", "Shadcn ui", "API"],
    },
    {
      src: project3,
      title: "Website Anime",
    ...
    },
    {
      ...
      framework: ["React", "Tailwind CSS", "Laravel", "Rest API"],
    },
    {
      src: project5,
      ...
      framework: ["Vue JS", "Tailwind CSS", "Laravel", "Rest API"],
    },
    {
      src: project6,
      title: "Website Movie",
      ...
      framework: ["JQuery", "Bootstrap", "API"],
    },
    {
      src: project7,
      ...
      framework: ["Laravel", "Bootstrap", "Rest API"],
    },
  ];
            ...
            {project.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="pt-5 pb-10 ">
                  <div className="group relative overflow-hidden flex flex-col gap-2 bg-primary/30 rounded-lg  p-3 shadow-[0_0_10px_rgba(0,0,0,0.8)]">
                    <div className="">
                      <img
                        src={item.src}
                        loading="lazy"
